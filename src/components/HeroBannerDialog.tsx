...
const HeroBannerDialog = forwardRef<HTMLDivElement, HeroBannerDialogProps>(
  ({ open, onOpenChange, banner, onSave, mode }, ref) => {
    ...
    return (
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent ref={ref} className="sm:max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
...
HeroBannerDialog.displayName = 'HeroBannerDialog';
