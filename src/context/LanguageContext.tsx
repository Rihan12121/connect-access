...
const translations: Translations = {
  ...
  'favorites.yourSelection': { de: 'Ihre Auswahl', en: 'Your Selection' },
  ...
  'footer.description': { de: 'Deine E-Commerce Plattform für alles was du brauchst.', en: 'Your e-commerce platform for everything you need.' },
  ...
  'hero.welcome': { de: 'Willkommen bei Noor', en: 'Welcome to Noor' },
  'hero.tagline': { de: 'Deine E-Commerce Plattform für Qualitätsprodukte zu fairen Preisen', en: 'Your e-commerce platform for quality products at fair prices' },
  ...
  'hero.shopNow': { de: 'Jetzt entdecken', en: 'Discover Now' },
  'about.title': { de: 'Über uns', en: 'About Us' },
  'about.description': { de: 'Noor ist dein zuverlässiger Partner für hochwertige Produkte. Wir legen Wert auf Qualität, faire Preise und schnelle Lieferung. Unser Ziel ist es, dir das beste Einkaufserlebnis zu bieten – einfach, schnell und unkompliziert.', en: 'Noor is your reliable partner for high-quality products. We value quality, fair prices, and fast delivery. Our goal is to provide you with the best shopping experience – simple, fast, and hassle-free.' },
  ...
  'ui.collection': { de: 'Kollektion', en: 'Collection' },
  'ui.discover': { de: 'Entdecken Sie', en: 'Discover' },
  'ui.showAllProducts': { de: 'Alle Produkte anzeigen', en: 'Show all products' },
  'ui.limitedOffers': { de: 'Limitierte Angebote', en: 'Limited Offers' },
  'ui.bestseller': { de: 'Bestseller', en: 'Bestsellers' },
  'ui.inclVat': { de: 'inkl. MwSt.', en: 'incl. VAT' },
  'ui.freeShipping': { de: 'Kostenloser Versand ab 50€', en: 'Free shipping over €50' },
  'ui.securePayment': { de: 'Sichere SSL-Verschlüsselung', en: 'Secure SSL encryption' },
  'ui.returnPolicy': { de: '14 Tage Rückgaberecht', en: '14 day return policy' },
  'ui.secureOrder': { de: 'Sichere Bestellung', en: 'Secure Order' },
  'ui.browseCategories': { de: 'Durchstöbern Sie unsere sorgfältig kuratierten Kategorien', en: 'Browse our carefully curated categories' },
  'ui.discoverProducts': { de: 'Produkte entdecken', en: 'Discover products' },
  'ui.yourFavorites': { de: 'Ihre Lieblings-Produkte', en: 'Your favorite products' },
  'ui.youSave': { de: 'Sie sparen', en: 'You save' },
  'ui.freeShippingFrom': { de: 'Kostenloser Versand', en: 'Free shipping' },
  'ui.from50': { de: 'Ab 50€ Bestellwert', en: 'On orders over €50' },
  'ui.securePaymentTitle': { de: 'Sichere Zahlung', en: 'Secure Payment' },
  'ui.sslEncryption': { de: 'SSL-Verschlüsselung', en: 'SSL encryption' },
  'ui.mayAlsoLike': { de: 'Das könnte Ihnen auch gefallen', en: 'You may also like' },
  'ui.products': { de: 'Produkte', en: 'Products' },
  'ui.allCategories': { de: 'Alle Kategorien', en: 'All Categories' },
  'ui.filter': { de: 'Filter', en: 'Filter' },
  'ui.resetFilter': { de: 'Filter zurücksetzen', en: 'Reset filter' },
  'filter.title': { de: 'Filter', en: 'Filter' },
  'filter.all': { de: 'Alle', en: 'All' },
  'filter.dealsOnly': { de: 'Nur Angebote', en: 'Deals only' },
  'filter.inStock': { de: 'Auf Lager', en: 'In stock' },
  'categories.subcategories': { de: 'Unterkategorien', en: 'Subcategories' },
  'search.suggestions': { de: 'Vorschläge', en: 'Suggestions' },
  'search.history': { de: 'Verlauf', en: 'History' },
  'search.clearHistory': { de: 'Löschen', en: 'Clear' },
};
